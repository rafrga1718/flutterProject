...
class PerfilGrupo extends StatelessWidget {
  @override
    ...
    Widget titleSection = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          FastText(0.0, 12.0, 'Nombre del grupo ', 26.0, Colors.black87),
          new Row(
            children: <Widget>[
              new Container(
              ...
              new Container(
                margin: const EdgeInsets.only(left: 32.0, top: 8.0),
                child:
                new Icon(Icons.info, color: Colors.black87),
              ),
              new Container(
